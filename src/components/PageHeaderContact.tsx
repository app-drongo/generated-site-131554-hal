...
// Generated: 2025-08-20T16:58:31.003Z
// Section: page-header
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative py-16 sm:py-20 lg:py-24 max-w-4xl">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-3xl">
            Whether you're a startup, SMB, or enterprise, our team is here to provide you with a flexible and scalable banking solution. 
