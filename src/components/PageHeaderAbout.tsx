...
// Generated: 2025-08-20T16:58:30.137Z
// Section: page-header
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative py-16 sm:py-20 lg:py-24 max-w-4xl">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-3xl">
            At BankX, we're dedicated to providing startups, SMBs, and enterprises with a flexible and scalable banking platform that
            adapts to your unique business needs. Discover how our cutting-edge services can help you thrive in the digital economy.
          </p>
        </div>
      </div>
    </section>
