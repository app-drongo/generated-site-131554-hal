...
// Generated: 2025-08-20T16:58:30.670Z
// Section: cta
// Category: cta
...
export default function CTA() {
  const stats = [
    { value: "10K+", label: "Startups Onboarded", icon: Users },
    { value: "99.99%", label: "Uptime Guarantee", icon: Shield },
    { value: "250+", label: "Banking Integrations", icon: Zap },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join the thousands of startups thriving with BankX. Start your
                free trial today and experience the future of banking.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Trusted by leading startups and accelerators
                </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Startup-Friendly</h3>
              <p className="text-sm text-muted-foreground">
                Tailored banking solutions for growing startups
              </p>
            </div>
          </div>
        </div>
